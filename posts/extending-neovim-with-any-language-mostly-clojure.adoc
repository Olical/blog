...
I needed a _real_ Clojure implementation to parse and format the results I was getting out of the https://oli.me.uk/2019-03-22-clojure-socket-prepl-cookbook/[socket prepl].
